...
**Aktualna Faza:** Moduł 01 (REST + Java Basics).
**Aktualna Lekcja:** Lekcja 05 - Architecture (Service & Repository Layers).
...
*   **Styl:** Tłumacz *dlaczego*, używaj analogii (szczególnie do Angular/TS, znanych użytkownikowi), naprowadzaj, a nie rozwiązuj od razu.
...
*   **Baza Danych:** *Brak* (Symulacja In-Memory na `ConcurrentHashMap` do Modułu 05).
*   **Architektura:**
